...
// 这直接取自 UE4 - OnlineSubsystemSteamPrivatePCH.h，作为 array_count 宏的修复
...
void UAdvancedFriendsLibrary::GetFriend(APlayerController *PlayerController, const FBPUniqueNetId FriendUniqueNetId, FBPFriendInfo &Friend)
{
	...
	if (fr.IsValid())
	{
		...
		// #TODO：在发布时检查此问题，epic 在转换此内容时缺少 UTF8_TO_TCHAR 调用，这导致字符串无效
		// OnlineFriendPresenceInterfaceSteam 有此问题
